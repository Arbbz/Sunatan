  ...
  return (
    <section className="bg-gold-50 p-6 rounded-2xl shadow-inner mb-8">
      <div className="text-center mb-6">
        <h3 className="text-2xl font-great-vibes text-maroon-500 mb-2">
          Bride & Groom
        </h3>
        <p className="text-sm text-gray-600 leading-relaxed max-w-sm mx-auto">
          mengurangi rasa hormat, kami bermaksud mengundang Bapak/Ibu/Saudara/i
      ...
      <div className="flex flex-col items-center justify-center space-y-8">
        ...
        >
          ...
          />
          <h4 className="text-5xl font-great-vibes text-maroon-500 mb-2 name-content">
            Debby
          </h4>
          <p className="text-xl font-bold text-maroon-600 mb-2">
            Arnida Debby Fittaloka
          </p>
          <p className="text-sm text-gray-600 leading-relaxed">
            Putri ke 1 dari
          </p>
          <p className="text-md font-medium text-maroon-500">
            Putri ke 1 dari Bapak Agus Eko Supriyanto (Alm.) dan Ibu Safilinda
          </p>
        </div>
        ...
        >
          <img
            ...
            className="w-30 h-32 rounded-full mx-auto mb-4 border-4 border-maroon-500 shadow-lg object-cover transform hover:scale-105 transition-transform duration-300"
          />
          <h4 className="text-5xl font-great-vibes text-maroon-500 mb-2 header-content">
            Ihsan
          </h4>
          <p className="text-xl font-bold text-maroon-600 mb-2">
            Muhamad Nur Ihsan S
          ...
          <p className="text-md font-medium text-maroon-500">
            Bapak R. Bagus Rahmat Susanto dan Ibu Sri Hartati
          </p>
        </div>
      </div>
    </section>
