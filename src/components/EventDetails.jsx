    ...
    <div>
      ...
      >
        <div className="premium-card mx-auto max-w-md p-6">
          <h3 className="mb-6 text-center text-2xl font-bold text-maroon-700">
            Detail Acara
          </h3>

          <div className="grid gap-5">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-red-100 text-2xl shadow">
                📅
              </div>
      ...
      <section className="px-5 pb-10" data-aos="fade-right">
        <div className="premium-card mx-auto max-w-md p-6">
          <h3 className="mb-5 text-center text-2xl font-bold text-green-800">
            📍 Lokasi Acara
          </h3>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="maps-btn mt-6 block rounded-xl py-4 text-center font-semibold text-white"
          >
